...
class TimeTest {
  ...
  @Test(timeout=60000) def euler023 = time(23)(Euler023)
  @Test(timeout=60000) def euler024 = time(24)(Euler024)
  @Test(timeout=60000) def euler025 = time(25)(Euler025)
  @Test(timeout=60000) def euler026 = time(26)(Euler026)
  @Test(timeout=60000) def euler027 = time(27)(Euler027)
  @Test(timeout=60000) def euler028 = time(28)(Euler028)
  @Test(timeout=60000) def euler029 = time(29)(Euler029)
  ...
  @Test(timeout=60000) def euler035 = time(35)(Euler035)
  @Test(timeout=60000) def euler036 = time(36)(Euler036)
  @Test(timeout=60000) def euler037 = time(37)(Euler037)
  @Test(timeout=60000) def euler040 = time(40)(Euler040)
  @Test(timeout=60000) def euler041 = time(41)(Euler041)
  @Test(timeout=60000) def euler042 = time(42)(Euler042)
